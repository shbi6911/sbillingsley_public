...
g = 1;
for N = [5,10,20,30,40,60,1000]

    % This for loop works to create text files for the coordinates for each of the NACA
    % airfoils needed for questions 1
...
for a = NACA
    ...
    % This for loop works to create text files of the coordinates for each of the NACA
    % airfoils needed for questions 2-3
...
fprintf("Number of Panels = 50 Panels\n")
...
% Reads in coordinate files we created using the NACA_aifoils function
...
% Using The Vortex_Panel function and a for loop we calculate the CL of
% NACA 0012 for AoA = 12, with differing amount of panels
% used toi estimate the shape of the airfoil
...
fprintf("NACA 0012 CL @ AOA = 12 is " + num2str(CL_0012_1000) + "\n")




%% PLOTTING Q1
% This plots all the CL data obtained in the last section 
...
% Reads in coordinate data poreviously created
...
%% CALCULATING CL
% Using the Vortex_Panel function and a user created ThinAirfoilTheory_symmetric function
% We can calulate two seperate CL vectors for an alpha vector of varying
% angles of attack.
...
%% CALCULATING DCL/DALPHA AND ALPHA_L=0
% Using the polyfit function we can calculate dCL/dALPHA and ALPHA_L=0 if
% we model the line as a 1st degree polynomial
...
%% TABLE CREATION
% Creates a table with the values obtained in the previous section
...
% Reading in digitized wind tunnel data

NACA0006_dat = readmatrix("NACA 0006 DATA.csv");
NACA0012_dat = readmatrix("0012_cl_alpha_data.txt");

%% PLOTTING Q2
% Plotting Vortex_Panel function vs ThinAirfoilTheory_symmetric function vs
% Experimental Data 
...
%% GETTING DATA FOR Q3
% Gathering data from text files created at the start of the code
...
%% CALCULATING CL
% Using the Vortex_Panel function to claculate CL for airoils NACA 2412 and
% 4412
...
%% FINDING DCL/DALPHA AND ALPHA_L=0
% Using polyfit to find dCL/dALPHA and a custom function to find ALPHA_L=0
...
%% TABLE CREATION
% Creating table with dCL/dALPHA and ALPHA_L=0 for NACA 2412 and 4412
...
%% CALCULATING CL USING TAT
% Using a custom function to caculate CL from ALPHA and ALPHA_L=0 using
% thin airfoil theory adjusted for cambered airfoils
...
% Reading in digitized experimental data
...
%display L/D for the given angle of attack
disp("The L/D for the given conditions is "+aero_eff(27));
