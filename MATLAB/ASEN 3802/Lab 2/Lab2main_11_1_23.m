...
for ll=1:8
    plot(const.data.steel.time,const.data.steel.("th"+string(ll)),'r');
    plot(const.data.steel.time,U.steel.an.alpha6(ll,:),'b');
end
title("Temperature Progression of Steel (Model 1A Analytical)");
xlabel ("Time (s)");
ylabel ("Temperature (degrees C)");
hold off;
%legend ([h g],["Experimental Data" "Analytical Result"],'location','eastoutside');

figure(5);
hold on;
for ll=1:8
    plot(const.data.Brass26.time,const.data.Brass26.("th"+string(ll)),'r');
    plot(const.data.Brass26.time,U.Brass26.an.alpha6(ll,:),'b');
end
...
hold on;
for ll=1:8
    plot(const.data.Brass29.time,const.data.Brass29.("th"+string(ll)),'r');
    plot(const.data.Brass29.time,U.Brass29.an.alpha6(ll,:),'b');
end
...
hold on;
for ll=1:8
    plot(const.data.Alum25.time,const.data.Alum25.("th"+string(ll)),'r');
    plot(const.data.Alum25.time,U.Alum25.an.alpha6(ll,:),'b');
end
...
hold on;
for ll=1:8
    plot(const.data.Alum28.time,const.data.Alum28.("th"+string(ll)),'r');
    plot(const.data.Alum28.time,U.Alum28.an.alpha6(ll,:),'b');
end
...
for ll=1:8
    plot(const.data.steel.time,const.data.steel.("th"+string(ll)),'r');
    plot(const.data.steel.time,U.steel.exp.alpha6(ll,:),'k');
end
...
for ll=1:8
    plot(const.data.Brass26.time,const.data.Brass26.("th"+string(ll)),'r');
    plot(const.data.Brass26.time,U.Brass26.exp.alpha6(ll,:),'k');
end
...
for ll=1:8
    plot(const.data.Brass29.time,const.data.Brass29.("th"+string(ll)),'r');
    plot(const.data.Brass29.time,U.Brass29.exp.alpha6(ll,:),'k');
end
...
for ll=1:8
    plot(const.data.Alum25.time,const.data.Alum25.("th"+string(ll)),'r');
    plot(const.data.Alum25.time,U.Alum25.exp.alpha6(ll,:),'k');
end
...
for ll=1:8
    plot(const.data.Alum28.time,const.data.Alum28.("th"+string(ll)),'r');
    plot(const.data.Alum28.time,U.Alum28.exp.alpha6(ll,:),'k');
end
...
%           constant value of H (slope of the temperature line)
%           constant value of L (distance from T_0 to heater)
%           linear fit array M with slope and intercept
%   OUTPUT: values of b_n as a scalar or as an array
