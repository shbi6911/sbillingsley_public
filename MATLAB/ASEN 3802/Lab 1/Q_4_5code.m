...
figure(2);  %plot convergence for lift
hold on;
%plot(lift,'o');
plot(lift_conv);
...
figure(3);  %plot convergence for drag
hold on;
%plot(drag,'o');
plot(drag_conv);
...
figure (4); %plot polyfit line against data to check compliance
hold on;
...
figure (5); %plot polyfit line against data to check compliance
hold on;
...
figure (6); %plot polyfit line against data to check compliance
hold on;
...
figure (7); %plot polyfit line against data to check compliance
hold on;
