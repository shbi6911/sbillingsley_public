...
% c!!old!!$ ap,pt))*pt(1)
gggg = globe5(day, sec, glat, glong, stl, f107a, f107, ap, pt);
...
g0		= ptm(4)*ps(1)*(1.0 + sw(19)*...
		globe5(day, sec, glat, glong, stl, f107a, f107, ap, ps));
% eq. a5
s		= g0/(tinf - tlb);
% eq. a11
...
xmd		= 28.0 - xmm;
[tz, b28] = denss(zh28, db28, tinf, tlb, xmd, -1.0, ptm(6), s, t0, za, z0, tr12);
if ((alt < altl(3)) && (sw(15) ~= 0.0))
	[tz, dm28] = denss(alt, b28, tinf, tlb, xmm, 0.0, ptm(6), s, t0, za, z0, tr12);	
	% eq. a12
...
% eq. a18
g4		= sw(21)*globe5(day, sec, glat, glong, stl, f107a, f107, ap, pd(1,:));
...
% eq. a18
g16		= sw(21)*globe5(day, sec, glat, glong, stl, f107a, f107, ap, pd(2,:));
...
% eq. a18
g32		= sw(21)*globe5(day, sec, glat, glong, stl, f107a, f107, ap, pd(4,:));
...
% eq. a18
g40		= sw(21)*globe5(day, sec, glat, glong, stl, f107a, f107, ap, pd(5,:));
...
% eq. a18
g1		= sw(21)*globe5(day, sec, glat, glong, stl, f107a, f107, ap, pd(6,:));
...
% eq. a18
g14		= sw(21)*globe5(day, sec, glat, glong, stl, f107a, f107, ap, pd(7,:));
