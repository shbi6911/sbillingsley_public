...
% hold on; grid on;                           % single trajectory
% scatter(trajectories.time3674,trajectories.data3674(:,2),5,"red","filled","o");       
...
%
if n == 1
    params = [61.25*(101325/14.7);0.00195;0.425;((3*pi)/16)]; %define default case
else
    ...
    %structure."
    airpressure = linspace(30,80,n);
    airpressure = airpressure .* (101325/14.7);
    watervolume = linspace(0.0005,0.0015,n);
    dragcoefficient = linspace(0.2,0.8,n);
    launchangle = linspace((pi/6),(pi/3),n);
