% Some Matlab plotting hints

% load the data
% save variable names or they'll be overwritten by the following files.
% Note the signals may have different time vectors, so we need to keep them
% all!
...
% No need for a legend this time.




%% Now do your FFT magic!
